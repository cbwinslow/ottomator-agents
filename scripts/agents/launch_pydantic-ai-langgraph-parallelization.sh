...
# Launch script for pydantic-ai-langgraph-parallelization
# Auto-generated by create_agent_scripts.sh

AGENT_DIR="/home/runner/work/ottomator-agents/ottomator-agents/pydantic-ai-langgraph-parallelization"
